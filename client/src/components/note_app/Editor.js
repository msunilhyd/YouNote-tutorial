...
import { FormatBold, FormatItalic, FormatUnderlined, Code, FormatListBulleted, FormatListNumbered, 
            FormatQuote, LooksTwo, Looks3 } from '@material-ui/icons';
        ...
        <Grid container direction='column' >
            ...
            <Slate 
                ...
                <Toolbar >
                    ...
                    <MarkButton format="underlined" icon={<FormatUnderlined />} />
...
const toggleBlock = (editor, format) => {
    ...
    Transforms.unwrapNodes(editor, {
        match: n => LIST_TYPES.includes(format),
        split: true,
    })
