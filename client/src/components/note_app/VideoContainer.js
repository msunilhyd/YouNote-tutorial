...
const VideoContainer = (props) => {
    ...
    return (
        <Grid container direction='column' justify='center' alignItems='center' component={Card} item xs={12}
            md={6} elevation={5}>
            <Grid container spacing={2} direction={column} justify='space-between' alignItems='strech' style={{padding: '10px', height: '100%'}}>
